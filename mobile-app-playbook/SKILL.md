...
## §6–§8. Launch, ASO, and post-launch → `reference/launch-and-growth.md`

Once the build is real, read **[reference/launch-and-growth.md](reference/launch-and-growth.md)**:
store submission gates and the staged-rollout dwell ladder (§6), ASO as a product surface
— listing, keywords, review-prompt policy, localization (§7), and running the app as a
service afterwards — LiveOps cadence, crash/ANR budgets, rating recovery (§8).
